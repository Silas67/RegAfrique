        ...
        <div className="w-full relative flexcent flex-col overflow-hidden">
          ...
          >
            ...
            <div className="flexbet lg:flex-row h-full w-full text-textcolor relative z-10 ">
              <div className="w-full lg:w-[70%] ">
                ...
                >
                  Business rules are complex. We make them simple — so you can
              ...
              <div className="lg:flex-1 md:flex-1/2">
                <Copy>
                  ...
                  <p className=" pt-[16px] text-[#b2b2b2]  text-justify ">
                    Navigating Africa’s regulatory environment can be
                    overwhelming — but you don’t have to do it alone. At
                    Regafrique, we act as your trusted partner, helping you
                    decode complex laws, avoid costly mistakes, and create
                  ...
                  <p className=" text-[#b2b2b2] pt-[16px] md:hidden lg:block text-justify">
                    ...
                    compliance, and confidence. With Regafrique by your side,
                    you’re never in the dark — you’re always ahead.
                  </p>
                </Copy>
              </div>
            </div>
          ...
          <section className="w-full px-8 lg:px-[100px] py-20 ">
            <Copy>
              ...
              <p className="lg:text-3xl pt-2 text-xl w-full">
                Because peace of mind is powerful - our clients sleep better
                knowing that
                <span className="text-neutral-600">
                  {" "}
            ...
            <div className="w-full flexcent text-center py-5 flex-col">
              <Copy>
                ...
                <p className="md:text-lg max-w-2xl  text-neutral-400 text-center mt-3">
                  ...
                  you&apos;re protecting your vision. We handle the rules, so
